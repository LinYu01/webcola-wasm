...
import { DerivativeComputerWasmInst } from 'wasmEngine';
...
declare class Projection {
    ...
    xProject(x0: Float32Array, y0: Float32Array, x: Float32Array): void;
    yProject(x0: Float32Array, y0: Float32Array, y: Float32Array): void;
    projectFunctions(): {
        (x0: Float32Array, y0: Float32Array, r: Float32Array): void;
    }[];
    private project;
    private solve;
}
...
declare class Layout {
     ...
     */
    start(initialUnconstrainedIterations?: number, initialUserConstraintIterations?: number, initialAllConstraintsIterations?: number, gridSnapIterations?: number, keepRunning?: boolean, centerGraph?: boolean): Promise<this>;
...
declare class Descent {
     ...
     */
    get D(): Float32Array[];
    computeDerivatives(x: Float32Array[]): void;
    locks: Locks;
    ...
    rungeKutta(): number;
    private static mid;
    takeDescentStep(x: Float32Array, d: Float32Array, stepSize: number): void;
...
declare class Layout3D {
    ...
    descent: Descent;
    start(iterations?: number): Promise<Layout3D>;
    tick(): number;
}
